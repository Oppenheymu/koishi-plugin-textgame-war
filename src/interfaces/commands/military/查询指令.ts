...
import { 计算地貌速度修正, 计算战场宽度, 计算攻击地形地貌修正 } from "#ctx/military/domain/战场宽度";
import { 地形攻击修正, 地形速度修正, 组织度警告线 } from "#ctx/military/domain/types/常量";
import { 战斗状态 } from "#ctx/military/domain/types/枚举";
import { 陆军装备名单 } from "#ctx/military/domain/types/装备属性表";
