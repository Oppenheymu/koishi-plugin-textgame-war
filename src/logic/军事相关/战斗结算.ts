...
import { 聚合军队面板, 计算HP衰减系数, 计算经验修正 } from "./属性聚合.js";
import { 计算战场宽度, 计算攻击地形地貌修正, 计算超宽惩罚 } from "./战场宽度.js";
import { HP分级, 加载联军名称缓存, 向地区绑定群推送, 组织度分级 } from "./战报推送.js";
import { 计算行军毫秒数, 选择撤退目的地 } from "./行军计算.js";
