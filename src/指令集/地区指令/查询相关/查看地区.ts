...
const 容量配置 = [
    { 标签: "基建", 当前字段: "当前总基础设施", 已用字段: "使用的基础设施", 上限字段: "基础设施上限" },
    { 标签: "机场", 当前字段: "当前总机场容量", 已用字段: "使用的机场容量", 上限字段: "机场容量上限" },
    { 标签: "公路", 当前字段: "当前总公路容量", 已用字段: "使用的公路容量", 上限字段: "公路容量上限" },
    { 标签: "居民", 当前字段: "当前总居民区容量", 已用字段: "使用的居民区容量", 上限字段: "居民区容量上限" },
    { 标签: "仓储", 当前字段: "当前总仓库容量", 已用字段: "使用的仓库容量", 上限字段: "仓库容量上限" },
    { 标签: "港口", 当前字段: "当前总港口容量", 已用字段: "使用的港口容量", 上限字段: "港口容量上限" },
] as const;
