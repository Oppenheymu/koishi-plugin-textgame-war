...
import { TerrainType, CapacityBase, CapacityLimit, RegionBasicDataItem } from '../Types/地区相关';

const logger = new Logger('malie-初始化地区表');
...
function 判定地区地形(地区: RegionBasicDataItem): TerrainType {
  const { MeanElevation: 平均海拔, MaxElevation: 最大海拔, MinElevation: 最小海拔, STDElevation: 地区崎岖度 } = 地区;
...
const CAPACITY_BASELINE: Partial<Record<TerrainType, CapacityBase>> = {
  [TerrainType.平原]: { 基础设施: 12_000_000, 公路: 18_000_000, 机场: 6_000_000, 港口: 6_000_000, 居民区: 20_000_000, 仓库: 15_000_000 },
  [TerrainType.高原]: { 基础设施: 9_000_000, 公路: 12_000_000, 机场: 7_000_000, 港口: 4_000_000, 居民区: 12_000_000, 仓库: 11_000_000 },
  [TerrainType.浅丘]: { 基础设施: 8_000_000, 公路: 10_000_000, 机场: 5_000_000, 港口: 3_000_000, 居民区: 10_000_000, 仓库: 9_000_000 },
  [TerrainType.深丘]: { 基础设施: 6_000_000, 公路: 8_000_000, 机场: 4_000_000, 港口: 2_000_000, 居民区: 8_000_000, 仓库: 7_000_000 },
  [TerrainType.低山]: { 基础设施: 5_000_000, 公路: 6_000_000, 机场: 4_000_000, 港口: 1_500_000, 居民区: 6_000_000, 仓库: 6_000_000 },
  [TerrainType.中山]: { 基础设施: 4_000_000, 公路: 5_000_000, 机场: 3_000_000, 港口: 1_200_000, 居民区: 5_000_000, 仓库: 5_000_000 },
  [TerrainType.高山]: { 基础设施: 3_000_000, 公路: 3_000_000, 机场: 2_000_000, 港口: 800_000, 居民区: 3_000_000, 仓库: 4_000_000 },
};
const DEFAULT_CAPACITY: CapacityBase = { 基础设施: 0, 公路: 0, 机场: 0, 港口: 0, 居民区: 0, 仓库: 0 };

function 获取容量基线(地形: TerrainType): CapacityBase {
  return CAPACITY_BASELINE[地形] ?? DEFAULT_CAPACITY;
}

function 获取容量上限(地区: RegionBasicDataItem, 地形: TerrainType): CapacityLimit {
  if (地区.isOcean) {
  ...
  const 海拔系数 = 地区.MeanElevation >= 2500 ? 0.78 : 地区.MeanElevation >= 1500 ? 0.88 : 地区.MeanElevation >= 800 ? 0.95 : 1.05;
